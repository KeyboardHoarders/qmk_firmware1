/666666666666666667t555555555555555555555555555555555555555555555555555521/ Copyright 2023 QMK   o
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_5x15(
        ...
        KC_LCTL,   KC_LGUI,   KC_LALT,            KC_SPC,            KC_RALT,   NUMBER,   KC_RCTL,   KC_LEFT,   KC_DOWN,   KC_RIGHT
    ),
